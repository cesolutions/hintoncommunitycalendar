  ...
  <div class="lg:flex lg:h-full lg:flex-col">
    ...
    <div class="shadow ring-1 ring-black/5 lg:flex lg:flex-auto lg:flex-col">
      ...
      <div class="flex bg-gray-200 text-xs/6 text-gray-700 lg:flex-auto">
        ...
        >
          <div
            v-for="day in calendarState.days"
            :key="day.date"
            :class="[
    ...
    <div
      v-if="calendarState.selectedDay?.events.length > 0"
    ...
    >
      ...
      >
        <li
          v-for="event in calendarState.selectedDay.events"
          :key="event.id"
...
onMounted(() => {
  ...
  //loop over the current month to populate the calendar.
  for (
    let i = moment().startOf("month");
    i.isSameOrBefore(endOfMonth);
    i.add(1, "day")
  ) {
    if (i.isSame(startOfMonth)) {
      calendarState.days.push({
        date: i.format("yyyy-MM-DD").toString(),
        isCurrentMonth: true,
        isSelected: true,
        events: [
          {
      ...
      //add the day to the calendar array.
      calendarState.days.push({
        date: i.format("yyyy-MM-DD").toString(),
        isCurrentMonth: true,
        events: [],
  ...
  calendarState.selectedDay = calendarState.days.find((day) => day.isSelected);
